...
| ⛔ **NESSUN tetto di righe** su un elenco: si mostrano tutte quelle del filtro, ovunque                                    | stile §elenchi   |
| ⭐ **Il piede — totali e comandi — si ANCORA in fondo** sotto `lg`, e rende inutile il tetto                               | stile §elenchi   |
| ⭐ **La fascia totali è un CONTO sul telefono**: una colonna di numeri, non celle affiancate                               | stile §riepilogo |
| ⭐ **La barra strumenti sta su UNA riga** anche sul telefono; la ricerca prende la riga sua                                | stile §mobile    |
| ⚠️ **I pulsanti di BARRA scendono a 40px** sotto `md`; campi e form restano a 44                                           | stile §4         |
| ⭐ **Il respiro della card è asimmetrico**: 8px verticali, 12px orizzontali                                                | stile §4         |
| ⛔ **`align-items` sopravvive al cambio d'asse**: in colonna `center` centra in ORIZZONTALE                                | stile §mobile    |

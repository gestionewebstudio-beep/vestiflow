...
| #         | Riserva                                                                                                                                                                                                                                                                                                                                                                         | Stato                                                              |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| A.4.1     | **`invoice_draft` è davvero la Fattura?** A.3.2 propone `credit_note → invoice_draft` perché così fa l'accompagnatoria. Se `invoice_draft` fosse la Fattura proforma, la mappatura sarebbe sbagliata in partenza: la proforma ha un progressivo suo. Va **letto**, non assunto                                                                                                  | **APERTO — verifica**                                              |

...
| A.1.10 | **Regola generale dell'uscita fisica**: il documento che registra per primo l'uscita genera il movimento. I successivi ereditano o referenziano quell'evento, non lo replicano. ⭐ È la regola vigente, e ora ha le sue sedi operative: `12` §«La regola fisica, che sta SOPRA la matrice» la argomenta, `07` §5-bis la applica riga per riga                                                                                                                                                                                                                                                                                                   | 14/08 · ⛔ il rimando «§19.1» era **morto**, corretto il 22/08 |
| A.1.11 | **Default di «Scarica mag.» sulla FAMIGLIA fattura** (accompagnatoria compresa): segue l'origine **della riga**. Documento a monte — **agganciato O da cui questo documento deriva** — che ha già registrato l'uscita → non spuntata. Nessun documento a monte → spuntata. **L'Ordine cliente non conta come uscita**: impegna, non scarica. ⛔ Qui c'era **«Documento agganciato»**, che copre la sola INCLUSIONE: un documento **generato** da una Vendita al banco cadeva nel ramo «nessun documento a monte» e nasceva spuntato, seconda registrazione della stessa uscita. Elenco completo delle sei origini in `07` §5-bis _(22/08/2026)_ | **15/08**                                                      |
...
| A.2.4     | ⛔ **SUPERATO — NON USARE COME REQUISITO** _(22/08/2026)_. Qui c'era: «La **Fattura non scarica** magazzino; l'**Accompagnatoria sì**». È una voce **secca per tipo, senza condizioni**, e il tipo non decide: decide l'**origine della riga**. Sostituita da `12` §«La regola fisica, che sta SOPRA la matrice» e da `07` §5-bis (le sei origini). La Fattura scarica eccome, quando è lei la prima a registrare l'uscita; l'accompagnatoria non scarica, se l'uscita è già avvenuta | 14/08                       |

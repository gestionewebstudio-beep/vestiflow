...
describe('InventoryController', () => {
  ...
  it('previewLevelsImport propaga l’utente al servizio import', async () => {
    ...
    expect(inventoryImport.previewCsv).toHaveBeenCalledWith(tenantId, expect.any(String), user);
  });
  ...
  it('getCount delega al service conteggi', async () => {
    ...
    await expect(controller.getCount(tenantId, user, 'count-1')).resolves.toEqual({
      id: 'count-1',
    });

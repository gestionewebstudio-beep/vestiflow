...
describe('sospendiLaPrimaRichiesta — chiusura delle risorse', () => {
  ...
  it('⛔ transazione FALLITA prima di dichiarare il pid: rifiuta, non resta appesa', async () => {
  ...
  it('⛔ transazione CONCLUSA senza dichiarare il pid: rifiuta dicendo cosa manca', async () => {
  ...
  it("l'aggiornamento che fallisce DENTRO la transazione continua a rifiutare", async () => {
  ...
  it('chiudi() sblocca e attende, ed e` idempotente', async () => {
  ...
  it('chiudi() non propaga il fallimento della transazione: e` una PULIZIA', async () => {
